ALTER TABLE lazaro.common_expenses
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_common_expenses_period_version
    ON lazaro.common_expenses(condominium_id, period_yyyymm, version_no);

CREATE UNIQUE INDEX IF NOT EXISTS idx_common_expenses_period_confirmed
    ON lazaro.common_expenses(condominium_id, period_yyyymm)
